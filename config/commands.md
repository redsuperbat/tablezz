...
| GoBackward |  | `Control + o` | [src/table/DataTableProvider.tsx:341](https://github.com/redsuperbat/tablezz/blob/main/src/table/DataTableProvider.tsx#L341) |
...
| GoToForeignKeyRelation | Move to the entry where the cursor is at | `g > d` | [src/table/DataTableProvider.tsx:349](https://github.com/redsuperbat/tablezz/blob/main/src/table/DataTableProvider.tsx#L349) |
...
| GoToReferences | Show tables that reference the current cell's key value | `g > r` | [src/table/DataTableProvider.tsx:374](https://github.com/redsuperbat/tablezz/blob/main/src/table/DataTableProvider.tsx#L374) |
...
| OpenCellEditor | Open the cell editor for the current selection. | `c` | [src/table/DataTableProvider.tsx:299](https://github.com/redsuperbat/tablezz/blob/main/src/table/DataTableProvider.tsx#L299) |
...
| WriteChanges | Write pending cell changes and row deletions to the database. | `w` | [src/table/DataTableProvider.tsx:214](https://github.com/redsuperbat/tablezz/blob/main/src/table/DataTableProvider.tsx#L214) |
